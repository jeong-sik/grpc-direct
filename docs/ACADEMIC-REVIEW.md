...
**비판:**
> "7,400 RPS is decent but not impressive. Bun's HTTP server does 100k+ RPS.
> The bottleneck is clearly in your HTTP/2 implementation (h2 library).
> Consider direct syscall usage like io_uring for Linux."
...
| Metric | 현재 | 목표 | grpc-go | tonic |
|--------|------|------|---------|-------|
| RPS (unary) | 7,400 | **15,000+** | 7,900 | 20,000 |
| P50 latency | 70µs | **50µs** | 70µs | 50µs |
| P99 latency | 290µs | **150µs** | 260µs | 100µs |
| Memory/req | ~500B | **<100B** | ~200B | ~50B |
