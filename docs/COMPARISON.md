...
|---------------|-----------|-----|-----------------|----|----------|
| **grpc-direct (OCaml)** | **Full (interop pass)** | bridge+ws | High | Mid-High | Mid-High |
...
| Feature | grpc-direct (OCaml) | grpc-go | tonic (Rust) | grpcio (Python) | grpc-java |
|---------|------------------|---------|--------------|-----------------|-----------|
| **Protocol** |
...
| Google ADC | ❌ | ✅ | ❌ | ✅ | ✅ |
| **Code Gen** |
| protoc plugin | ✅ protoc-gen-grpc-direct | ✅ | ✅ prost | ✅ | ✅ |
| Reflection | ✅ | ✅ | ✅ | ✅ | ✅ |
...
|----------------|-------|-----------|
| **grpc-direct** | Eio effects (structured concurrency) | Simple, composable, no callbacks |
...
|----------------|-------------|----------|
| **grpc-direct** | OCaml (strong, inferred) | No runtime type errors, compile-time guarantees |
...
|----------------|-------|---------|
| **grpc-direct** | Result type | `(string, Status.t) result` |
