...
let create (name : string) : t =
  { name; methods = Hashtbl.create 16 }
...
let add_server_streaming (method_name : string) (handler : server_streaming_handler) (service : t) : t =
  let method_def = {
    name = method_name;
...
let add_client_streaming (method_name : string) (handler : client_streaming_handler) (service : t) : t =
  let method_def = {
    name = method_name;
